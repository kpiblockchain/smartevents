...
export class Organization extends SoltsiceContract {
    ...
    static async New(deploymentParams: W3.TC.TxParams, ctorParams?: {_name: string}, w3?: W3, link?: SoltsiceContract[]): Promise<Organization> {
    ...
    */
    ...
    public createEvent = Object.assign(
        // tslint:disable-next-line:max-line-length
        // tslint:disable-next-line:variable-name
        (_name: string, _registrationOpenFrom: BigNumber | number, _registrationOpenTo: BigNumber | number, _maxAttendants: BigNumber | number, _amountForPresence: BigNumber | number, txParams?: W3.TC.TxParams): Promise<W3.TC.TransactionResult> => {
            return new Promise((resolve, reject) => {
                this._instance.createEvent(_name, _registrationOpenFrom, _registrationOpenTo, _maxAttendants, _amountForPresence, txParams || this._sendParams)
                    .then((res) => resolve(res))
                    .catch((err) => reject(err));
            });
        },
        {
            // tslint:disable-next-line:max-line-length
            // tslint:disable-next-line:variable-name
            sendTransaction: (_name: string, _registrationOpenFrom: BigNumber | number, _registrationOpenTo: BigNumber | number, _maxAttendants: BigNumber | number, _amountForPresence: BigNumber | number, txParams?: W3.TC.TxParams): Promise<string> => {
                return new Promise((resolve, reject) => {
                    this._instance.createEvent.sendTransaction(_name, _registrationOpenFrom, _registrationOpenTo, _maxAttendants, _amountForPresence, txParams || this._sendParams)
                        .then((res) => resolve(res))
                        .catch((err) => reject(err));
                });
            }
        },
        {
            // tslint:disable-next-line:max-line-length
            // tslint:disable-next-line:variable-name
            data: (_name: string, _registrationOpenFrom: BigNumber | number, _registrationOpenTo: BigNumber | number, _maxAttendants: BigNumber | number, _amountForPresence: BigNumber | number): Promise<string> => {
                return new Promise((resolve, reject) => {
                    resolve(this._instance.createEvent.request(_name, _registrationOpenFrom, _registrationOpenTo, _maxAttendants, _amountForPresence).params[0].data);
                });
            }
        },
        {
            // tslint:disable-next-line:max-line-length
            // tslint:disable-next-line:variable-name
            estimateGas: (_name: string, _registrationOpenFrom: BigNumber | number, _registrationOpenTo: BigNumber | number, _maxAttendants: BigNumber | number, _amountForPresence: BigNumber | number): Promise<number> => {
                return new Promise((resolve, reject) => {
                    this._instance.createEvent.estimateGas(_name, _registrationOpenFrom, _registrationOpenTo, _maxAttendants, _amountForPresence).then((g) => resolve(g));
                });
            }
        });
