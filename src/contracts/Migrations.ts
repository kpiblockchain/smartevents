...
export class Migrations extends SoltsiceContract {
    static get Artifacts() { return require('../../build/contracts/Migrations.json'); }
    ...
    static async New(deploymentParams: W3.TC.TxParams, ctorParams?: {}, w3?: W3, link?: SoltsiceContract[]): Promise<Migrations> {
    ...
    */
    ...
    // tslint:disable-next-line:max-line-length
    // tslint:disable-next-line:variable-name
    public last_completed_migration( txParams?: W3.TC.TxParams): Promise<BigNumber> {
        return new Promise((resolve, reject) => {
